...
describe('DiscordGMService', () => {
	...
	beforeEach(() => {
		...
		// Initialize service
		discordGMService = DiscordGMService.initialize(
			mockClient as Client,
			mockDiscordService as DiscordService
		);
	...
	describe('initialization', () => {
		it('should create a singleton instance', () => {
			...
			const instance1 = DiscordGMService.initialize(
				mockClient as Client, 
				mockDiscordService as DiscordService
			);
			const instance2 = DiscordGMService.initialize(
				mockClient as Client, 
				mockDiscordService as DiscordService
			);
	...
	describe('processGMCommand', () => {
		it('should process valid gm-note commands', async () => {
			// Mock private method
			const processNoteSpy = jest.spyOn(discordGMService as any, 'processGMNote')
		...
		it('should handle unknown GM commands', async () => {
			...
			const sendGMAlertSpy = jest.spyOn(discordGMService, 'sendGMAlert')
