export const ChadBotConfig = {
	Name: 'ChadBot',
	Avatars: {
		Default: 'https://i.imgur.com/JDnFMXr.jpg'
	},
	Patterns: {
		// Chad triggers when someone uses these words/patterns
		Trigger: /\b(chad|trad|gym|alpha|sigma|beta|lifting|gains|protein|masculinity|grindset|hustle|king|kings|mindset|testosterone|hardo|hardbody)\b/i,
	...
	// The chance that ChadBot will respond to a trigger (0-100)
	ResponseRate: 75
};

export default ChadBotConfig;