 ...
 */
import { addMilliseconds, differenceInMilliseconds, isAfter, isBefore, isWithinInterval } from 'date-fns';
 ...
 */
export function formatRelativeTime(date: Date, comparisonDate: Date = new Date()): string {
...
export class PerformanceTimer {
	 ...
	 */
	public static createTimingWrapper(
		labelPrefix: string = '',
	): <T extends (...args: unknown[]) => unknown>(fn: T, methodName: string) => T {
