...
export const MOCK_LLM_RESPONSES = {
	...
	EMPTY_RESPONSE: '',
	LONG_RESPONSE:
		'This is a very long response that goes on and on and on to test how the system handles lengthy outputs from the LLM service that might exceed normal limits.',
...
export class MockLLMManager {
	 ...
	 */
	createPromptCompletion = jest
		.fn()
		.mockImplementation(async (promptType: PromptType, userMessage: string, options?: any): Promise<string> => {
