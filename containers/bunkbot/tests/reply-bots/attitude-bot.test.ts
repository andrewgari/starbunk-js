...
import { ATTITUDE_BOT_RESPONSES, ATTITUDE_BOT_NAME, ATTITUDE_BOT_AVATAR_URL } from '../../src/reply-bots/attitude-bot/constants';
...
describe('Attitude Bot', () => {
	...
	describe('Edge Cases', () => {
		...
		it('should handle very long messages', async () => {
			...
			const longContent = 'This is a very long message that goes on and on and on and you can\'t stop it from being really really long with lots of text';
