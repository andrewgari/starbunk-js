...
- **Phase 2: The Security Gate:** Run Snyk scans via `.github/instructions/snyk_rules.instructions.md` for any dependency or code changes. Fix issues _before_ delegating.
