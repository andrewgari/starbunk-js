...
import {
	generateSheeshResponse,
	SHEESH_BOT_NAME,
	SHEESH_BOT_AVATAR_URL,
} from '../../src/reply-bots/sheesh-bot/constants';
...
describe('Sheesh Bot', () => {
	...
	describe('Edge Cases', () => {
		...
		it('should handle very long messages containing "sheesh"', async () => {
			...
			const longContent =
				'This is a very long message that goes on and on and mentions sheesh somewhere in the middle of all this text';
