...
describe('WebhookService', () => {
	...
	beforeEach(() => {
		...
		(webhookService as unknown as { webhookClient: WebhookClient }).webhookClient =
			mockWebhookClient as WebhookClient;
	...
	describe('writeMessage', () => {
		...
		it('should use the right bot identity even when multiple bots send messages', async () => {
			...
			expect(bot1Webhook.send).toHaveBeenCalledWith(
				expect.objectContaining({
					username: 'Bot1',
					avatarURL: 'https://example.com/bot1.jpg',
					content: 'Message from Bot 1',
			...
			expect(bot2Webhook.send).toHaveBeenCalledWith(
				expect.objectContaining({
					username: 'Bot2',
					avatarURL: 'https://example.com/bot2.jpg',
					content: 'Message from Bot 2',
