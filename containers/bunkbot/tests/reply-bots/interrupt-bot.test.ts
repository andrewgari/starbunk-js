	...
	describe('Helper Functions', () => {
		describe('createInterruptedMessage', () => {
			...
			it('should handle special test cases', () => {
				...
				expect(createInterruptedMessage('Did somebody say BLU?'))
					.toBe('Did somebody say--- Oh, sorry... go ahead');
				
				expect(createInterruptedMessage('Supercalifragilisticexpialidocious'))
					.toBe('Supercalif--- Oh, sorry... go ahead');
			});
